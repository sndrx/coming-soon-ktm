...
const TextCursorProximity = React.forwardRef(
  (
    { label, styles, containerRef, radius = 50, falloff = "linear", className, onClick, ...props },
    ref
  ) => {
    ...
    return (
      <p ref={ref} className={`${className}`} onClick={onClick} {...props}>
